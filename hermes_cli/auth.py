...
ZAI_ENDPOINTS = [
    ...
    ("coding-global", "https://api.z.ai/api/coding/paas/v4",  ["glm-5.3", "glm-5.1", "glm-5v-turbo", "glm-4.7"], "Global (Coding Plan)"),
    ("coding-cn",     "https://open.bigmodel.cn/api/coding/paas/v4", ["glm-5.3", "glm-5.1", "glm-5v-turbo", "glm-4.7"], "China (Coding Plan)"),
]
